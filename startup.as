	...
	; Compiler options:
	;
	; -oCYTEST-C16.cof -mCYTEST-C16.map --summary=default --output=default \
	; CYTEST-C16.p1 init.p1 --chip=16F72 -P --runtime=default --opt=default \
...
;	26 bytes of RAM objects in common bank to zero
	...
	movwf	FSR
	movlw	low(__Lcommon+26)		;load the high address+1 into W
